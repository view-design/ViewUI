...
const components = {
    ...
    QAlert: Alert,
    QAnchor: Anchor,
    QAnchorLink: AnchorLink,
    QAutoComplete: AutoComplete,
    QAvatar: Avatar,
    QBackTop: BackTop,
    QBadge: Badge,
    QBreadcrumb: Breadcrumb,
    QBreadcrumbItem: Breadcrumb.Item,
    QButton: Button,
    QButtonGroup: Button.Group,
    QCard: Card,
    QCarousel: Carousel,
    QCarouselItem: Carousel.Item,
    QCascader: Cascader,
    QCell: Cell,
    QCellGroup: Cell.Group,
    QCheckbox: Checkbox,
    QCheckboxGroup: Checkbox.Group,
    QCol: Col,
    QCollapse: Collapse,
    ...
    QDrawer: Drawer,
    QDropdown: Dropdown,
    QDropdownItem: Dropdown.Item,
    QDropdownMenu: Dropdown.Menu,
    QFooter: Footer,
    QForm: Form,
    QFormItem: Form.Item,
    QHeader: Header,
    ...
    QList: List,
    QListItem: List.Item,
    QListItemMeta: List.Item.Meta,
    QLoadingBar: LoadingBar,
    QMenu: Menu,
    QMenuGroup: Menu.Group,
    QMenuItem: Menu.Item,
    QMessage: Message,
    QModal: Modal,
    QNotice: Notice,
    QOption: Option,
    QOptionGroup: OptionGroup,
    QPage: Page,
    QPanel: Collapse.Panel,
    QPoptip: Poptip,
    QProgress: Progress,
    QRadio: Radio,
    QRadioGroup: Radio.Group,
    QRate: Rate,
    QRow: Row,
    QSelect: Select,
    QSlider: Slider,
    ...
    QTime: Time,
    QTimeline: Timeline,
    QTimelineItem: Timeline.Item,
    QTimePicker: TimePicker,
    QTooltip: Tooltip,
    QTransfer: Transfer,
    QTree: Tree,
    QUpload: Upload
...
const install = function(Vue, opts = {}) {
    ...
    Vue.prototype.$QLoading = LoadingBar;
    Vue.prototype.$QMessage = Message;
    Vue.prototype.$QModal = Modal;
    Vue.prototype.$QNotice = Notice;
    Vue.prototype.$QSpin = Spin;
};
